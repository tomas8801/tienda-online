...
class productoController {
    ...
    public function index() {
        ...
        require_once '../app/resources/views/producto/destacados.php';
    }
    public function ver(){
        if (isset($_GET['id'])) {
            $id = $_GET['id'];
            ...
            require_once '../app/resources/views/producto/ver.php';
        }
    }
    public function gestion() {
        ...
        require_once '../app/resources/views/producto/gestion.php';
    }

    public function crear() {
        Utils::isAdmin();
        require_once '../app/resources/views/producto/crear.php';
    }
